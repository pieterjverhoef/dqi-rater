  ...
  return new Promise((resolve) => {
    ...
    exec(cmd, { timeout: SYNC_TIMEOUT_MS, maxBuffer: 50 * 1024 * 1024 },
      ...
      if (err) {
        ...
        // Without this, new Drive uploads would sit on disk but never
        // appear in the rater (auto-registration only ran at startup).
        let newImages = 0;
        if (_db) {
          try {
        ...
        status.last_result = { ok: true, duration_s: duration, new_images: newImages };
      }
